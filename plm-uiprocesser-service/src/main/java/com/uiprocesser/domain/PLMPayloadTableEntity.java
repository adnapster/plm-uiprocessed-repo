package com.uiprocesser.domain;
...
public class PLMPayloadTableEntity extends TableServiceEntity implements Comparable<PLMPayloadTableEntity> {
	...
	@Override
	public int compareTo(PLMPayloadTableEntity o) {
		Date firstDateTime =  new Date();
		Date secondDateTime = new Date();
		try {
			firstDateTime = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss").parse((this.CreatedDate == null || this.CreatedDate.equals("NA")) ? "1969-01-01 00:00:00 EST":this.CreatedDate.replaceAll("/", "-"));
			secondDateTime = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss").parse((o.CreatedDate == null || o.CreatedDate.equals("NA")) ? "1969-01-01 00:00:00 EST":o.CreatedDate.replaceAll("/", "-"));
		} catch (ParseException e) {
			try {
				firstDateTime = new SimpleDateFormat("yyyy-MM-dd HH:mm").parse((this.CreatedDate == null || this.CreatedDate.equals("NA")) ? "1969-01-01 00:00:00 EST":this.CreatedDate.replaceAll("/", "-"));
				secondDateTime = new SimpleDateFormat("yyyy-MM-dd HH:mm").parse((o.CreatedDate == null  || o.CreatedDate.equals("NA")) ? "1969-01-01 00:00:00 EST":o.CreatedDate.replaceAll("/", "-"));
			} catch (Exception e1) {
				e1.printStackTrace();
			}
		}
